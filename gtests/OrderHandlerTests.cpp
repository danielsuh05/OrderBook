...
TEST(OrderHandlerTest, OrderExecutedMessage) {
	...
	auto orderExec = ITCHOrder<ITCHMessageType::EXECUTE_ORDER>::parse(reinterpret_cast<const char*>(buffer));
...
TEST(OrderHandlerTest, OrderExecutedWithPriceMessage) {
	...
	auto orderExecPrice = ITCHOrder<ITCHMessageType::EXECUTE_ORDER>::parse(reinterpret_cast<const char*>(buffer));
...
TEST(OrderHandlerTest, OrderCancelMessage) {
	...
	auto orderCancel = ITCHOrder<ITCHMessageType::CANCEL_ORDER>::parse(reinterpret_cast<const char*>(buffer));
...
TEST(OrderHandlerTest, OrderDeleteMessage) {
	...
	auto orderDelete = ITCHOrder<ITCHMessageType::DELETE_ORDER>::parse(reinterpret_cast<const char*>(buffer));
...
TEST(OrderHandlerTest, OrderReplaceMessage) {
	...
	auto orderReplace = ITCHOrder<ITCHMessageType::REPLACE_ORDER>::parse(reinterpret_cast<const char*>(buffer));
