...
struct ITCHOrder<ITCHMessageType::EXECUTE_ORDER> {
	...
	inline ITCHOrder(uint16_t stockLocate, uint64_t timestamp, uint64_t id, uint32_t quantity);
...
struct ITCHOrder<ITCHMessageType::CANCEL_ORDER> {
	...
	inline ITCHOrder(uint16_t stockLocate, uint64_t timestamp, uint64_t id, uint32_t numCancelled);
...
struct ITCHOrder<ITCHMessageType::REPLACE_ORDER> {
	...
	inline ITCHOrder(uint16_t stockLocate, uint64_t timestamp, uint64_t oldId, uint64_t newId, uint32_t quantity, uint32_t price);
